...
from yourbench.utils.prompts import SUMMARIZATION_USER_PROMPT, SUMMARIZATION_USER_PROMPT_ZH
...
def _prepare_inference_calls(dataset: Dataset) -> list[InferenceCall]:
    ...
    for doc_text in documents:
        user_msg_content = SUMMARIZATION_USER_PROMPT_ZH.format(document=doc_text)
